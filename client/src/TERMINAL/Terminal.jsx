...
import getCommandsFromUser from './_comp/getCommandsFromUser';
...
const COMMANDS = getCommandsFromUser(USER);
  useEffect(() => {
    changeTheme(theme);
  }, [theme]);
  ...
  return (
    <>
      <TerminalLayout terminalRef={terminalRef}
        className={"terminal bg-primary-bg text-primary-text p-0 pt-0 rounded-lg shadow-lg md:w-3/4 w-11/12 md:mt-0 overflow-y-auto flex flex-col relative border-2 border-primary-color border-opacity-50 h-[80vh] max-h-[90vh] "+className}
